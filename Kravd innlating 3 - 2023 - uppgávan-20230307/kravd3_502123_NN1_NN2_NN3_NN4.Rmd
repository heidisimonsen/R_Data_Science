...
```
    ...
    við flest ferðsluóhappum henda á kommunalvegi. 
    Um vit hyggja at Eysturoyar sýsla sast at tali av ferðsluóhapp ávíkavist á kommunalvegi og á landavegi,
    eru tali av hendingum meria eins enn í hinum sýslunum.
    Eysturoyar sýsla og Sandoyar sýsla, eru tær sýslurnar sum sast at í nøkrum av árinum, 
    hava tær haft mest ferðsluóhapp á landaveginum í mun til hinar sýslurnar, 
    sum í flestu førum hava mest fersluóhap á kommunalvegi. 
    Suðuroyar og Vága sýslurnar síggja vit at flestu áruni eru flest fersluóhapp á kommunalveginum,
    men munurin í millum ávíkavist á kommunalvegi og landavegi er ikki líka týðiligur, 
    sum við Streymoyar sýsla og Norðoya sýsla.  
